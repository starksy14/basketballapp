      ...
      <h1>William & Mary schedule</h1>
        ...
        <div className="grid-container">
          ...
          <div className="row">
            <div className="col-sm">
            <h4>Team roster</h4>
              <h2>{WilliamMaryname1}</h2>
              <h2>{WilliamMaryname2}</h2>
              <h2>{WilliamMaryname3}</h2>
              <h2>{WilliamMaryname4}</h2>
              <h2>{WilliamMaryname5}</h2>
              <h2>{WilliamMaryname6}</h2>
              <h2>{WilliamMaryname7}</h2>
              <h2>{WilliamMaryname8}</h2>
              <h2>{WilliamMaryname9}</h2>
              <h2>{WilliamMaryname10}</h2>
            </div>
          </div>
        </div>
      </div>
