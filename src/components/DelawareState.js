      ...
      <h1>Delaware State schedule</h1>
        ...
        <div className="grid-container">
          ...
          <div className="row">
            <div className="col-sm">
            <h4>Team roster</h4>
              <h2>{DelawareStname1}</h2>
              <h2>{DelawareStname2}</h2>
              <h2>{DelawareStname3}</h2>
              <h2>{DelawareStname4}</h2>
              <h2>{DelawareStname5}</h2>
              <h2>{DelawareStname6}</h2>
              <h2>{DelawareStname7}</h2>
              <h2>{DelawareStname8}</h2>
              <h2>{DelawareStname9}</h2>
              <h2>{DelawareStname10}</h2>
            </div>
          </div>
        </div>
      </div>
