...
const BryantComponent = ({ generateBryantNames }) => {
  ...
  useEffect(() => {
    ...
    if (storedPlayers) {
      ...
      const generatedNames = generateBryantNames(myArray1, myArray2);
...
const generateBryantNames = (myArray1, myArray2) => {
...
export { BryantComponent, generateBryantNames };
